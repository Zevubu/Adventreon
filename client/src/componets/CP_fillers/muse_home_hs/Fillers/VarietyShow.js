...
import {BigBlock,LookBtn,SlideShadowBox,LookBox,H2, HeaderItem,SpHeaderA, DivWBorder, H2T} from "../../../../styles/homeStyle";
...
function Shows (){
    ...
    useEffect(() => {
        const fetchShowsCNT = async () =>{
            ...
            // console.log(`Music variety count #${count.data[0].total} true false check:${count.data[0].total !== 0}`)
