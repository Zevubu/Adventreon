...
import { BigBlock,LookBtn,SlideShadowBox,LookBox, SpHeaderA, H2, HeaderItem, DivWBorder, H2T} from "../../../../styles/homeStyle";
...
function Shows (){
    ...
    useEffect(() => {
        const fetchShowsCNT = async () =>{
            ...
            // console.log(`Performance play count #${count.data[0].total} true false check:${count.data[0].total !== 0}`)
