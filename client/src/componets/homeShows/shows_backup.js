        ...
        <div> 
            <DivWBorder>
                ...
                <TealHeader>
                    <HeaderItem>
                        <Logo>Shows</Logo>
                        <a className="nav-link" href="/shows" style={{textDecoration: 'none'}}><Button variant="contained" color="secondary">Veiw All</Button></a>  
                    </HeaderItem>
                </TealHeader>
                <ServiceBlock>
                    <TriServiceBlock>
                        ...
                        <a href="/shows" style={{textDecoration: 'none'}}><Button variant="contained" color="Primary">whatch this show</Button></a>
                    </TriServiceBlock>
                    <TriServiceBlock>
                        <HoldDiv>
                        <Paper style={{width: '100%',height: '100%'}}></Paper>
                        ...
                        <a href="/shows" style={{textDecoration: 'none'}}><Button variant="contained" color="Primary">love Better Now</Button></a>
                    </TriServiceBlock>
                    <TriServiceBlock>
                        <HoldDiv>
                        <Paper style={{width: '100%',height: '100%'}}></Paper>
                        ...
                        <a href="/shows"><Button variant="contained" color="Primary">Be Better Now</Button></a>
                    </TriServiceBlock>
                </ServiceBlock>
            </DivWBorder>
            {/*Service continued  */}
