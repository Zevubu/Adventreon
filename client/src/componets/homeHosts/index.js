...
import { BigBlock, MarronHeader, SpHeaderA, DivWBorder, H2, HeaderItem} from "../../styles/homeStyle";
...
// opacity: vis ,
    return(
        <BigBlock>
            ...
            <DivWBorder Margin ="0px 0px 23px 0px" BDcolor="rgba(180, 180, 180, 0.2)">
            <SpHeaderA BGcolor="rgba(180, 180, 180, 0.1)">
                <HeaderItem>
                <H2                            
