...
router.post('/register', async (req, res) => {
    ...
    const {first_name, last_name, user_name, dob, email, password, title, about, p_img, b_img, category, payment, patreon, wp_title, webpage, rsvp_attend, rsvp_perform, verified} = req.body;
        ...
        const result = await create(
            ...
            [first_name, last_name, user_name, 'host', false, dob, email, cryptPass, title, about, p_img, b_img, category, payment, patreon, wp_title, webpage, rsvp_attend, rsvp_perform, verified]  
        );
        const user = result;
