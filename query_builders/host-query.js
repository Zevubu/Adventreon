...
const hostQuery ={
    ...
    findById: () => `SELECT id, user_name, email, title, about, p_img, b_img, catagory, payment, patreon, wp_title, webpage, rsvp_attend, rsvp_perform, verified, time_stamp FROM users WHERE id = ? AND user_type='host' OR user_type='manager' AND mhswitch=1`,
